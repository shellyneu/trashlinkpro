...
class LoginPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        canvas.create_text(500, 150, text="Login", fill="#2f4f12", font=("Inter", 28, "bold"))
        
        nim_label = tk.Label(self, text="NIM", font=("Inter", 14, "bold"), bg="white", fg="#2f4f12")
        nim_label.place(x=305, y=235)
        ...
        self.nim_entry.place(x=295, y=265, width=450, height=40)
        ...
        input_.place(x=750, y=430, width=200, height=50)
