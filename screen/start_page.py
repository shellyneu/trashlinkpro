...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        canvas.create_text(500, 210, text="Welcome to", fill="#2f4f12", font=("Inter", 28, "bold"))
        canvas.create_text(500, 260, text="TRASHLINK PRO", fill="#2f4f12", font=("Inter", 32, "bold"))
        ...
        login_btn.place(x=80, y=430, width=200, height=50)
