...
class RegisterPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        canvas = tk.Canvas(self, width=1024, height=500, bg="white", highlightthickness=0)
        ...
        canvas.create_text(500, 150, text="Register", fill="#2f4f12", font=("Inter", 28, "bold"))
        
        nama_label = tk.Label(self, text="Nama", font=("Inter", 14, "bold"), bg="white", fg="#2f4f12")
        nama_label.place(x=305, y=210)
        ...
        self.nama_entry.place(x=295, y=240, width=450, height=40)

        nim_label = tk.Label(self, text="NIM", font=("Inter", 14, "bold"), bg="white", fg="#2f4f12")
        nim_label.place(x=305, y=295)
        ...
        self.nim_entry.place(x=295, y=325, width=450, height=40)
