...
class EndPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        canvas.create_text(500, 210, text="Poinmu = ...", fill="#2f4f12", font=("Inter", 28, "bold"))
        canvas.create_text(500, 260, text="Cetak voucher?", fill="#2f4f12", font=("Inter", 32, "bold"))
        ...
        close_btn.place(x=80, y=430, width=200, height=50)

        print_btn = tk.Button(self, image=canvas.button, text="Cetak", font=("Inter", 12, "bold"), fg="#2f4f12",
                                    compound="center", bd=0, bg="white", activebackground="white",
                                    command=lambda: controller.show_frame("StartPage"))
        print_btn.place(x=750, y=430, width=200, height=50)