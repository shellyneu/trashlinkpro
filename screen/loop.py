...
class LoopPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        canvas.create_image(1024, 500, image=canvas.bg_img, anchor="se")
        ...
        canvas.create_text(500, 210, text="Masukkan Botol", fill="#2f4f12", font=("Inter", 28, "bold"))
        canvas.create_text(500, 260, text="Satu-Persatu", fill="#2f4f12", font=("Inter", 28, "bold"))
        ...
        input_again_btn.place(x=80, y=430, width=200, height=50)
        ...
        finish_btn.place(x=750, y=430, width=200, height=50)
